...
df$Exclude <- ifelse(df$Exclude != 1,
                   # only look at participants not already excluded 
                   ifelse(df$chosen_outcome == 'Blue',
                   ...
                   df$Exclude)
# if participant already excluded, do not change the value
